    ...
    <div className="fixed inset-0 z-60 md:hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-72 bg-surface border-l border-outline-variant shadow-2xl flex flex-col animate-slide-in">
        <div className="flex items-center justify-between px-md h-16 border-b border-outline-variant/30">
          <span className="font-headline-md text-body-lg leading-[24px] font-bold text-on-surface">
            Menu
          </span>
          <button
            onClick={onClose}
            className="w-9 h-9 flex items-center justify-center text-on-surface-variant hover:text-on-surface hover:bg-surface-variant/50 rounded-full transition-colors"
          >
        ...
        {userName && (
          <div className="px-md py-sm border-b border-outline-variant/30">
            <p className="font-sans text-code-block leading-5 text-on-surface-variant">
              Hi,{" "}
        ...
        <div className="flex-1 overflow-y-auto py-sm">
          {navLinks.map((link) => (
            ...
            >
              ...
              <span className="font-sans text-body-md leading-[24px] font-medium">
                {link.label}
              </span>
              {isActive(link.path) && (
        ...
        <div className="px-md py-sm border-t border-outline-variant/30">
          ...
          >
            ...
            <span className="font-sans text-code-block leading-5">Search</span>
          </button>
        </div>
      </div>
    </div>
