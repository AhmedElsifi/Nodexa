      ...
      <article className="max-w-[1280px] mx-auto">
        <header className="mb-lg">
          <div className="flex items-center gap-xs mb-sm">
            ...
            <span className="text-on-surface-variant font-code text-label-sm leading-[16px] tracking-wider">
          ...
          <p className="font-sans text-body-lg leading-7 text-on-surface-variant">
            Understanding the core concepts, patterns, and best practices
        ...
        <div className="mt-xl pt-lg border-t border-outline-variant flex flex-col items-center gap-md">
          <button
            ...
            className={`px-xl py-sm rounded-lg font-headline-md text-headline-md leading-8 font-semibold flex items-center gap-sm transition-all duration-200 ${
              completed
          ...
          {completed && (
            <Link
              ...
              className="px-lg py-sm bg-tertiary/10 border border-tertiary/30 text-tertiary font-code text-label-sm leading-[16px] tracking-wider rounded-lg hover:bg-tertiary/20 hover:border-tertiary/50 transition-all flex items-center gap-xs"
            >
              Next: Tasks
